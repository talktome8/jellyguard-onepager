...
export default function Hero() {
  ...
  return (
    <div ref={sectionRef}>
      ...
      {/* Floating particles with spring motion */}
      ...
      <motion.div 
        className="absolute w-48 h-64 opacity-20 animate-glow-pulse -z-10 pointer-events-none"
        style={{ 
          top: '33%',
          right: '2rem',
          y: jellyfish2Y,
      ...
      <motion.div 
        className="absolute w-32 h-48 opacity-15 animate-glow-pulse -z-10 pointer-events-none"
        style={{ 
          top: '3rem',
          right: '25%',
          y: jellyfish3Y,
